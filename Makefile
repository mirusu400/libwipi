...
conformance:
	@echo "conformance package requires INSTALL_PROFILE=aram-wie-raptor"
	@false
endif
...
test-target-profile: $(LIBRARY) $(BUILD_DIR)/tests/layout-ktf.o \
	...
	python3 tests/check_lgt_disassembly.py $(VENEER_DISASSEMBLY)
	python3 tests/check_archive.py $(LIBRARY) $(NM) lgt-raptor
