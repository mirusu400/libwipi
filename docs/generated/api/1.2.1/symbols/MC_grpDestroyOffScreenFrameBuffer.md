...
```{doxygenfunction} MC_grpDestroyOffScreenFrameBuffer
:project: libwipi
```
...
Samsung/KTF selector confidence: `confirmed`. Catalog evidence: `anycall_magichole:analysis/decompiled/wipi_mc_grp_spec_adapter.c:739`.
