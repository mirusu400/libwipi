...
```{doxygenfunction} MC_miscGetLedCount
:project: libwipi
```
...
Samsung/KTF selector confidence: `confirmed`. Catalog evidence: `anycall_magichole:analysis/decompiled/wipi_mc_misc_spec_adapter.c:150`.
