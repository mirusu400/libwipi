...
```{doxygenfunction} MC_miscBackLight
:project: libwipi
```
...
|---|---|
| API level | `1.2.1` |
| Family | [`MC_MISC`](../families/misc.md) |
| Ordinal | 120 |
...
Samsung/KTF selector confidence: `confirmed`. Catalog evidence: `anycall_magichole:analysis/decompiled/wipi_mc_misc_spec_adapter.c:111`.
