...
```{doxygenfunction} MC_netSocketWrite
:project: libwipi
```
...
Samsung/KTF selector confidence: `confirmed`. Catalog evidence: `anycall_magichole:analysis/decompiled/wipi_mc_net_spec_adapter.c:631`.
