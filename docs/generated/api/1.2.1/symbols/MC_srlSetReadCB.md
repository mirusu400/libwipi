...
```{doxygenfunction} MC_srlSetReadCB
:project: libwipi
```
...
Samsung/KTF selector confidence: `confirmed`. Catalog evidence: `anycall_magichole:analysis/decompiled/wipi_mc_srl_spec_adapter.c:456`.
