...
```{doxygenfunction} MC_dbUpdateRecord
:project: libwipi
```
...
Samsung/KTF selector confidence: `confirmed`. Catalog evidence: `anycall_magichole:analysis/decompiled/wipi_mc_db_spec_adapter.c:365`.
