...
```{doxygenfunction} MC_mdaClipGetData
:project: libwipi
```
...
Samsung/KTF selector confidence: `confirmed`. Catalog evidence: `anycall_magichole:analysis/decompiled/wipi_mc_mda_spec_adapter.c:444`.
