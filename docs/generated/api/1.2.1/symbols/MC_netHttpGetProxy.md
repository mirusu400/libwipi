...
```{doxygenfunction} MC_netHttpGetProxy
:project: libwipi
```
...
Samsung/KTF selector confidence: `confirmed`. Catalog evidence: `anycall_magichole:analysis/decompiled/wipi_mc_http_spec_adapter.c:483`.
