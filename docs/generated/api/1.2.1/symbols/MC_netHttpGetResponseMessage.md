...
```{doxygenfunction} MC_netHttpGetResponseMessage
:project: libwipi
```
...
Samsung/KTF selector confidence: `confirmed`. Catalog evidence: `anycall_magichole:analysis/decompiled/wipi_mc_http_spec_adapter.c:523`.
