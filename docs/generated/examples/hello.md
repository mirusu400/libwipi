...
| `1.2.1` | `ktf-samsung` | `aram-ktf` | <span class="libwipi-package-download" data-package-key="1.2.1::ktf-samsung::aram-ktf::hello">Checked-in ZIP is added by the versioned documentation build.</span> |
